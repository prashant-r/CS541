...
public class TestDriver implements GlobalConst {
  ...
  //  sprintf( logpath, MINIBASE_LOG, nameRoot, getpid() );
    ...
    //dependent. 
    dbpath =  System.getProperty("user.dir") + "/tmp/"+nameRoot+System.getProperty("user.name")+".minibase-db"; 
    logpath =  System.getProperty("user.dir") + "/tmp/"+nameRoot +System.getProperty("user.name")+".minibase-log"; 
  }
